...
export const DEFAULT_PRODUCTS: Product[] = [
  ...
  { id: 'prod-kl-spinach', name: 'Spinach / Amaranthus (Cheera)', brand: 'Local', categoryId: 'cat-veg', defaultUnit: 'pack', isFavorite: true, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-capsicum', name: 'Capsicum / Bell Pepper', brand: 'Local', categoryId: 'cat-veg', defaultUnit: 'kg', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-greenpeas', name: 'Green Peas', brand: 'Local', categoryId: 'cat-veg', defaultUnit: 'kg', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-beans', name: 'Cowpea / Beans (Achinga Payar)', brand: 'Local', categoryId: 'cat-veg', defaultUnit: 'kg', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  ...
  { id: 'prod-kl-mustard', name: 'Mustard Seeds (Kaduku)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  ...
  { id: 'prod-kl-turmericpowder', name: 'Turmeric Powder (Manjal Podi)', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: true, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-chillipowder', name: 'Chilli Powder (Molaka Podi)', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: true, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-kashmirichilli', name: 'Kashmiri Chilli Powder', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z', notes: 'For colour, less heat' },
  { id: 'prod-kl-corianderpowder', name: 'Coriander Powder (Malli Podi)', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: true, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-pepperwhole', name: 'Black Pepper Whole (Kurumulaku)', brand: 'Local', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-pepperpowder', name: 'Black Pepper Powder', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-cumin', name: 'Cumin Seeds (Jeerakam)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-fennel', name: 'Fennel Seeds (Perinjeerakam)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-cardamom', name: 'Cardamom (Elakka)', brand: 'Local', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-cloves', name: 'Cloves (Grambu)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-cinnamon', name: 'Cinnamon (Karugapatta)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-staranise', name: 'Star Anise (Thakkolam)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-bayleaf', name: 'Bay Leaf (Karuvapatta)', brand: 'Generic', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-asafoetida', name: 'Asafoetida (Kayam)', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pcs', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-driedchilli', name: 'Dry Red Chilli (Vattal Mulaku)', brand: 'Local', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-rasampowder', name: 'Rasam Powder', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-biryanimasala', name: 'Biryani Masala', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-chickenmasala', name: 'Chicken Masala', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: true, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
  { id: 'prod-kl-currypowder', name: 'Kerala Curry Powder', brand: 'Eastern', categoryId: 'cat-spices', defaultUnit: 'pack', isFavorite: false, isActive: true, createdAt: '2026-05-01T00:00:00Z' },
